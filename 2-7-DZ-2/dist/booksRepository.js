...
let BooksRepository = class BooksRepository {
    ...
    createNewBook(book, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const newBook = new books_model_js_1.default(book1);
            yield newBook
                .save()
    ...
    updateBook(id, updatedBook, res) {
        ...
        books_model_js_1.default.findOneAndUpdate({ id: id }, updatedBook)
    ...
    deleteBook(id, res) {
        ...
        books_model_js_1.default.findOneAndDelete({ id: id })
            .then(res.send('OK'))
